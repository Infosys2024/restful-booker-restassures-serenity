...
public class BookingCRUDTestWithSteps extends TestBase {
    ...
    public static String firstname = "Jalpa" + TestUtils.getRandomValue();
    public static String lastname = "Sheth" + TestUtils.getRandomValue();
    public static Integer totalprice = 777;
